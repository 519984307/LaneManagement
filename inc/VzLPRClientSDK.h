...
/**
*  @brief 云服务器接口,根据appid和email获取新的appkey和appid
*  @param  [IN]  deviceip    云服务器的deviceip
*  @param  [IN]  port        云服务器的port
*  @param  [IN]  email       账号
*  @param  [IN]  password    密码
*  @param  [OUT] new_appid   新的appid
*  @param  [IN]  appid_len   appid长度
*  @param  [OUT] new_appkey  新的appkey
*  @param  [IN]  appkey_len  appkey长度
*  @return 返回值为0表示成功，返回其他值表示失败。
*  @ingroup group_device
*/
...
*  @brief 获取云平台的IP与端口 
*  @param [IN] handle 由VzLPRClient_Open函数获得的句柄
*  @param [OUT] deviceip 设备IP
*  @param [IN]  传入的IP字符串长度P
*  @param [OUT] port 设备端口
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
...
/**
*  @brief 云服务器接口,根据区域获取设备
*  @param  [IN] deviceip 云服务器的deviceip
*  @param  [IN] port     云服务器的port
*  @param  [IN] app_id   安全验证id
*  @param  [IN] appkey   账号
*  @parm   [IN] region_name 区域
*  @return 返回值为0表示成功，返回其他值表示失败。
*  @ingroup group_device
*/
...
*  @brief 设置车牌进入离开回调
*  @param [IN] handle 由VzLPRClient_Open函数获得的句柄
*  @param [IN] func 车牌进入离开回调
*  @param [IN] pUserData 用户自定义数据
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_LPRC_API int __STDCALL VzLPRClient_SetPlateEnterLeaveCallBack(VzLPRClientHandle handle, VZLPRC_PLATE_ENTER_LEAVE_CALLBACK func, void* pUserData);
