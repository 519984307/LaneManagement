...
int PlateCL::PlateInfoCallBack(VzLPRClientHandle handle, void *pUserData, const TH_PlateResult *pResult, unsigned uNumPlates, VZ_LPRC_RESULT_TYPE eResultType, const VZ_LPRC_IMAGE_INFO *pImgFull, const VZ_LPRC_IMAGE_INFO *pImgPlateClip)
{
    ...
    QString ff=QString("%1%2%3%4").arg(false_plate,false_plate,false_plate,false_plate);
    if(plate.indexOf(ff)!=-1){
        qCritical().noquote()<<QString("Not case:%1 Filtering false license plates").arg(plate);
        return -1;
    }
    int I=-1;
    int II=-1;
    ...
    if(S!=-1){
        ...
        if(I!=-1){
            II= plate.indexOf(false_plate,I+1);
        }
    }
    int E= plate.lastIndexOf(false_plate);
    if(S!=E && E!=I && I!=II && II!=E /*I==S+1 && E==I+1*/){
        qCritical().noquote()<<QString("Not case:%1 Filtering false license plates").arg(plate);
        return -1;
    }
...
void PlateCL::resumeShows()
{
    ...
    ******************************/
    ...
    /* 恒业物流 */
    QString msgOUT="F501002B000100010B0000010A2020BAE3D2B5B9FA0ABCCA020B0000010CD7A3C4FA0AD2BBC2B7CBB3B7E7030B02000100A5";
    ...
    ******************************/
    ...
    /* 恒业物流 */
    QString msgIN="F5010029000100010B0000010A2020BAE3D2B5B9FA0ABCCA020B0000010A2020BBB6D3ADC4FA0AA3A1030B0200010090";
